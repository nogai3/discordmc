...
public class Connection extends SimpleChannelInboundHandler<Packet<?>> {
    ...
    public static ChannelFuture connect(InetSocketAddress p_290034_, EventLoopGroupHolder p_450865_, final Connection p_290031_) {
        ...
        return new Bootstrap().group(p_450865_.eventLoopGroup(true)).handler(new ChannelInitializer<Channel>() {
            @Override
    ...
    public static Connection connectToLocalServer(SocketAddress p_129494_) {
        ...
        new Bootstrap().group(EventLoopGroupHolder.local().eventLoopGroup(true)).handler(new ChannelInitializer<Channel>() {
            @Override
