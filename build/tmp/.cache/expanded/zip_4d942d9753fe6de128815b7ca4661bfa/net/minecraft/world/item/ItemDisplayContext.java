...
public enum ItemDisplayContext implements StringRepresentable, net.minecraftforge.common.IExtensibleEnum {
    ...
    private ItemDisplayContext(net.minecraft.resources.Identifier serializeName, ItemDisplayContext fallback) {
    ...
    public static ItemDisplayContext create(String keyName, net.minecraft.resources.Identifier serializedName, @javax.annotation.Nullable ItemDisplayContext fallback) {
